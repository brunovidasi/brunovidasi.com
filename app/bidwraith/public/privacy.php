...
<ul>
    ...
    <li><strong>IP address:</strong> the address you saved each bid from, sent to eBay
        with that bid because eBay requires it.</li>
</ul>

<h2>Email</h2>
<p>Bidwraith emails your account's address to confirm it, to reset a forgotten
   password, when a bid you scheduled is placed or fails,
