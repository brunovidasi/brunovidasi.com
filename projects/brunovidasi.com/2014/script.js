...
;(function($){
	$.fn.TMForm=function(opt){
		...
		function TMForm(){
			...
			// 				$('.hidden-msg-success').attr('style', 'display:block;');
			// 			}else{							
			...
			// 				$('.hidden-msg-error').attr('style', 'display:block;');
			// 			}
...
/* ===== modal.js (Bootstrap modal, bundled as site JS) ===== */
/* ========================================================================
...
/* ===== WOW init (originally inline in head.php) ===== */
...
/* Copyright Year (hardcoded to 2014 for this preview)
========================================================*/
$(document).ready(function() {
  $("#copyright-year").text("2014");
});
