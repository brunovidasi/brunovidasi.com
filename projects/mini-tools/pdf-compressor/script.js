...
async function submitCompress() {
  ...
  try {
    ...
    if (e && e.message === 'ALREADY_ENCRYPTED') {
      showError('This PDF is password-protected. Remove the password first with the <a href="../pdf-password-remover/index.html">PDF Password Remover</a>, then compress it here.');
    } else {
