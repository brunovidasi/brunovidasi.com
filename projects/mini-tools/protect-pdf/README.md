...
- If the input file already has a password, this tool won't touch it — remove the existing password first with [Unlock PDF](../unlock-pdf/index.html), then add a new one here.
